  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="examApp.agency.home.createOrEditLabel" data-cy="AgencyCreateUpdateHeading">
            <Translate contentKey="examApp.agency.home.createOrEditLabel">Create or edit a Agency</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('examApp.agency.name')}
                id="agency-name"
                name="name"
                data-cy="name"
                type="text"
