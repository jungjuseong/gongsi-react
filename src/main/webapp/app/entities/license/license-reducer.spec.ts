...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './license.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LICENSE_LIST actions', async () => {
    ...
    it('dispatches FETCH_LICENSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LICENSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LICENSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LICENSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LICENSE actions', async () => {
      const expectedActions = [
        {
