...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './explain.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXPLAIN_LIST actions', async () => {
    ...
    it('dispatches FETCH_EXPLAIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EXPLAIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EXPLAIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EXPLAIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EXPLAIN actions', async () => {
      const expectedActions = [
        {
